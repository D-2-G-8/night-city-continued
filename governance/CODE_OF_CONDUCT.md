...
This project also treats the following as unacceptable, because of what it is:

* Passing off another author's work as your own, or stripping attribution from a mod,
  a recipe or a content pack
* Pressuring an author to change their license, leave their own distribution channels, or
  give up their donations as a condition of taking part
...
community leaders responsible for enforcement at **[conduct contact to be filled in]**.
...
Where a report concerns a community leader, that person takes no part in reviewing or
deciding it.
